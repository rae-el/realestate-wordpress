...
var pageNum = 1;
const url = 'https://realty-in-ca1.p.rapidapi.com/agents/get-listings?OrganizationId=147734&CurrentPage='+pageNum+'&RecordsPerPage=15&SortOrder=D&SortBy=6&CultureId=1'
const options = {
	method: 'GET',
	headers: {
