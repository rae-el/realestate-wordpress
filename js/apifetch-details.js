...
document.addEventListener("DOMContentLoaded", function(){
	...
	async function searchMLS(u,o){
		...
		if (d.Results.length > 0){
			...
			document.getElementById("property-area").innerHTML = "Sorry! Nothing popped up for that one, try another MLS number!";
		}
		}
		catch (e){
			console.error(e);
			document.getElementById("property-area").innerHTML = "Sorry! That didn't go through, try another MLS number!";
		}
	}
	searchMLS(u,o)
